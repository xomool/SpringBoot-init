...
public class UserController {
    ...
    /**
     * 获取用户列表
     * @param userQueryRequest 查询用户列表请求体
     * @param request 请求
     * @return 用户列表数据
     */
    @GetMapping("/list")
    ...
    public BaseResponse<Page<UserVO>> listUserByPage(UserQueryRequest userQueryRequest, HttpServletRequest request) {
        ...
        // 先通过userPage获取分页信息, 之后将数据赋予给该DTO对象
